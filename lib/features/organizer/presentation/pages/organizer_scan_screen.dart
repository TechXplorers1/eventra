                          ...
                          children: [
                            ...
                            AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                return Positioned(
                                  top: 32 + (_pulseController.value * (MediaQuery.of(context).size.width - 96)),
                                  left: 32, right: 32,
                                  child: Container(
                                    height: 2,
                                    decoration: BoxDecoration(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          width: 48, height: 48,
                          decoration: BoxDecoration(color: AppColors.secondary, shape: BoxShape.circle),
                          child: Icon(_flash ? LucideIcons.flashlight : LucideIcons.flashlightOff, size: 20, color: _flash ? AppColors.primary : AppColors.mutedForeground),
                        ),
                      ),
                    ),

                    // Demo: simulate scan vs actual booked tickets
                    Text('Demo: Simulate scan with real ticket data', style: TextStyle(fontSize: 12, color: AppColors.mutedForeground)),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: const Text('Valid Ticket', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                          ),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: const Text('Invalid Ticket', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                          ),
                        ),
                      ],
                    ),
